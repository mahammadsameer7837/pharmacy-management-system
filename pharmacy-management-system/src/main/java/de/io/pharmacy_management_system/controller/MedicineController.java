...
public class MedicineController {
	...
	public Medicine addM(@RequestBody Medicine med) throws MedicineAlreadyFoundException, ParseException {
		return medicineservices.addMedicine(med);
	}
	//Requirement-4: update medicine
	@PutMapping("/update-medicine/{id}")
	public String upMedicine(@PathVariable int id,@RequestBody Medicine medicine) throws MedicineNotFoundException, ParseException, MedicineNameTakenException {
