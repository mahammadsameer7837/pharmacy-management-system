...
public class DiseaseServicesImpl implements DiseaseService {
	...
	public Disease updateDiseaseName(int diseaseId, String diseaseName)
			throws DiseaseAllreadyFoundException, DiseaseNotFoundException {
		Disease disease;
		try {
	...
	@Override
	public String updateMedicationToDisease(int diseaseId, Medicine medicine) throws DiseaseNotFoundException, MedicineNotFoundException {
